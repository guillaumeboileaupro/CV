%%%%%%%%%%%%%%%%%
% CV tailored for Thales - Responsable IVV Avionique et moyens d'essais système "Iron Bird"
...
\tagline{Responsable IVV / Moyens d’essais système | Spatial, HIL/SIL ramp-up, validation, intégration HW/SW}
...
\cvevent{\textbf{Ingénieur intégration logiciel -- Interfaces terrain, support opérationnel \& validation}}{VEV Platform Services France}{2025 -- 2026}{Valbonne, France}
...
\begin{itemize}
  ...
  \item \textbf{Support opérationnel :} Analyse de flux FTP, interruptions d’échanges, incohérences de données et comportements applicatifs inattendus.
  \item \textbf{Investigation d’incidents :} Diagnostic technique, formalisation des constats et contribution aux actions de fiabilisation.
...
\cvevent{\textbf{Ingénieur R\&D senior -- IVV, simulation, performance \& validation système}}{CNES}{2023 -- 2025}{Nice, France}
...
\begin{itemize}
  \item \textbf{IVV / validation système :} Définition de contrôles de cohérence, règles de comparaison, méthodes de vérification et critères d’acceptabilité des résultats.
  ...
  \item \textbf{Risques \& anomalies :} Identification des écarts entre modèles, analyse d’impact, formalisation des points bloquants et proposition d’actions correctives.
...
\cvevent{\textbf{Data Scientist -- Bruit, modélisation dynamique \& analyse de performance}}{Universiteit Antwerpen, Belgium}{2021 -- 2023}{Antwerp, Belgium}
...
\textbf{Ingénieur docteur orienté IVV système, validation, simulation et intégration hardware/software, avec une expérience solide en environnement spatial international, analyse de performance, traitement du signal, données capteurs, logiciels scientifiques et documentation de revue.}

Mon parcours combine validation de systèmes complexes, simulation numérique, analyse d’anomalies, intégration de contributions hétérogènes, contrôles de cohérence, préparation de revues et support à la décision. J’ai travaillé sur des environnements exigeants associant logiciel, données, instrumentation, bruit, performance et contraintes opérationnelles.

\begin{itemize}
  \item Expérience en IVV, validation de résultats, plans de test numériques, analyse de performance et investigation technique.
  \item Culture forte du spatial, des systèmes complexes, des interfaces multiples, du logiciel scientifique et des données capteurs.
  \item Capacité à travailler avec des équipes intégrées : logiciel, système, instrumentation, modélisation, exploitation et validation.
  \item Profil autonome, rigoureux, calme, orienté essais, jalons, traçabilité, documentation et résolution de problèmes.
\end{itemize}
...
\cvevent{VEV -- Interfaces hardware/software, flux opérationnels \& support production}{Industrial software / Connected infrastructure}{2025 -- 2026}{}
...
\cvsubsection{IVV, stratégie de test \& moyens d’essais}

{\small
\cvtag{IVV système}
\cvtag{IVV logiciel}
\cvtag{Stratégie de test}
\cvtag{Plans d’essais}
\cvtag{Préparation d’essais}
\cvtag{Analyse d’essais}
\cvtag{Validation au sol -- ramp-up}
\cvtag{Bancs de test -- ramp-up}
\cvtag{SIL -- ramp-up}
\cvtag{HIL -- ramp-up}
\cvtag{Iron Bird -- ramp-up}
\cvtag{Recette moyens d’essais -- ramp-up}
\cvtag{Traçabilité}
...
\cvsubsection{Avionique, interfaces \& intégration HW/SW}

{\small
\cvtag{Avionique -- ramp-up}
\cvtag{Systèmes embarqués -- awareness}
\cvtag{Intégration hardware/software}
\cvtag{Interfaces sous-systèmes}
\cvtag{Interfaces logiciel / terrain}
\cvtag{Protocoles \& réseaux -- bases}
\cvtag{Électronique analogique / numérique -- bases}
\cvtag{Données capteurs}
\cvtag{GNC / modélisation dynamique -- awareness}
\cvtag{Boucle fermée -- awareness}
\cvtag{Fournisseurs techniques}
\cvtag{Sous-traitance -- awareness}
}

\divider\smallskip
\vspace{-.3cm}

\cvsubsection{Systèmes complexes, spatial \& AIT}
...
\cvtag{Essais démonstrateurs -- ramp-up}
\cvtag{Essais en vol -- awareness}
\cvtag{Environnement aéronautique -- ramp-up}
\cvtag{DO178B / ARP4754 / DO254 -- awareness}
}

\divider\smallskip
\vspace{-.3cm}

\cvsubsection{Signal, simulation \& performance}
...
\cvtag{Interfaces équipes intégrées}
