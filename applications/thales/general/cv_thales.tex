...
\tagline{Systems \& RAMS Engineer | Safety, Reliability, IVVQ, Risk Analysis \& Space Systems}
...
\cvevent{\textbf{Software Engineer -- System Integration, Operational Reliability \& Production Diagnostics}}{VEV Platform Services France}{2025 -- 2026}{Valbonne, France}
...
\item Analysed hardware/software interactions, operational data exchanges and service behaviours in production.
...
\item Supported verification, correction and monitoring of operational data flows, including FTP-based exchanges.
\item Contributed to issue diagnosis, prioritization and follow-up with technical stakeholders in an industrial operational context.
\item Strengthened experience with reliability, maintainability, service robustness and production constraints for software systems connected to physical infrastructure.
\end{itemize}
...
\item Supported activities aligned with \textbf{V-cycle engineering logic}: requirements interpretation, validation planning, consistency checks, result verification, anomaly analysis and technical evidence consolidation.
...
\item Structured validation workflows to compare outputs, verify expected behaviours, detect deviations, analyse non-conformities and consolidate technical evidence.
...
\cvevent{Continuous Professional Training -- Software, Data, AI and Systems}{OpenClassrooms}{2024 -- 2026}{28 completed courses}
...
\textbf{Systems and RAMS-oriented engineer with strong experience in complex system validation, risk analysis, reliability-oriented diagnostics and performance assessment in space and industrial software environments}. Background developed through major international collaborations including \textbf{LISA}, \textbf{LIGO--Virgo--KAGRA} and \textbf{Einstein Telescope}, complemented by recent industrial experience involving hardware/software interfaces, operational reliability and production issue analysis.

Experienced in \textbf{requirements-oriented validation}, \textbf{IVVQ support}, \textbf{risk identification}, \textbf{failure diagnostics}, \textbf{anomaly investigation}, \textbf{root-cause-oriented analysis}, \textbf{traceability}, \textbf{technical documentation}, \textbf{Python automation}, \textbf{software integration} and \textbf{cross-functional technical coordination}.
...
Relevant for \textbf{RAMS}, \textbf{Safety}, \textbf{Reliability}, \textbf{Availability}, \textbf{Maintainability}, \textbf{system verification}, \textbf{risk mitigation}, \textbf{technical reviews}, \textbf{space systems engineering} and \textbf{complex system validation}.

\cvsection{Fit for Thales RAMS / Safety}

\begin{itemize}
  \item Experience with complex space systems, mission-level performance constraints and precision-instrument environments requiring rigorous validation and technical evidence.
  \item Strong ability to identify failure scenarios, uncertainty sources, degraded behaviours, weak points and residual risks in complex software/data/system chains.
  \item Background in verification, validation, traceability, result consolidation, configuration follow-up and technical documentation.
  \item Experience in anomaly investigation, root-cause-oriented analysis and diagnostic reporting in both research and industrial software contexts.
  \item Familiar with system-level constraints, reliability of analysis chains, maintainability of technical workflows and robustness of operational services.
  \item Able to work at the interface between requirements, modelling, software, data, system performance and operational constraints.
  \item Relevant background for RAMS activities involving reliability, availability, maintainability, safety, risk analysis, conformity evidence and technical reviews.
  \item Comfortable in transnational and multidisciplinary environments requiring technical English, structured reporting, stakeholder alignment and execution rigor.
\end{itemize}
