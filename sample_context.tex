...
\textbf{Context:} Development of software for EV charging infrastructure (CPMS platform).

\textbf{Objective:} Build services for monitoring and data exchange with EV charging stations.
...
\textbf{Context:} Research and development activities related to space-based gravitational wave data analysis for the Laser Interferometer Space Antenna (LISA) mission.

\textbf{Objective:} Develop statistical and simulation tools to model astrophysical foregrounds and study the stochastic gravitational-wave background.
...
\item \textbf{Team coordination:} Supervision of interns and coordination of scientific software development tasks.

\item \textbf{Project coordination:} Organization of development tasks and model comparison workflows within collaborative research projects.
\end{itemize}
\divider
...
\textbf{Context:} Data analysis for gravitational-wave detector instrumentation and environmental noise characterization and seismic analyses.

\textbf{Objective:} Identify and model noise sources affecting the sensitivity of precision instruments using statistical inference methods.
...
\textbf{Context:} Research activities on gravitational-wave data analysis and astrophysical signal simulations.

\textbf{Objective:} Develop statistical and simulation methods to analyse complex astrophysical signals and background components.
...
\textbf{Role:} Contribution to analysis pipeline development and coordination of scientific software tasks within collaborative research teams.

\textbf{Budget:} Estimated at approximately 2 billion EUR over 10 years.
